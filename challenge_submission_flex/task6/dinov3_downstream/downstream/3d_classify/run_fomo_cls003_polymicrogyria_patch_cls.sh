...
TRAIN_SPLIT="${TRAIN_SPLIT:-split_v0_repeat20_val8_balanced}"
TEST_SPLIT="${TEST_SPLIT:-TEST_split_v0_8cases_balanced}"
OUTPUT_ROOT="${OUTPUT_ROOT:-${REPO_ROOT}/results/3d_classify/fomo_cls003_patch_cls_split_v0_repeat20_val8}"
