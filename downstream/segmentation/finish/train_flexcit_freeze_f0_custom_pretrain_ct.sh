#!/bin/bash
#SBATCH --job-name=train_flexcit_freeze_f0_custom_pretrain_ct
#SBATCH --output=sbatch_log/train_flexcit_freeze_f0_custom_pretrain_ct_%j.out
#SBATCH --nodes=1
...
export FOLD="${FOLD:-0}"
export TRAINER="${TRAINER:-flexict_patch8_freeze_Primus_v2_Trainer}"
