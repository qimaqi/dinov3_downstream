#!/bin/bash
#SBATCH --job-name=train_flexcit_onescale_patch_decode_f0_custom_pretrain_fomomri_fomo10k
#SBATCH --output=sbatch_log/train_flexcit_onescale_patch_decode_f0_custom_pretrain_fomomri_fomo10k_%j.out
#SBATCH --nodes=1
