#!/bin/bash
#SBATCH --job-name=train_flexcit_linear_prob_f0_custom_pretrain_mri_brats_ct_48
#SBATCH --output=sbatch_log/train_flexcit_linear_prob_f0_custom_pretrain_mri_brats_ct_48_%j.out
#SBATCH --nodes=1
...
export nnUNet_raw="/usr/bmicnas01/data-biwi-01/ct_video_mae_bmicscratch/data/nnUNet_raw"
export nnUNet_preprocessed="/usr/bmicnas03/data-biwi-01/qimaqi_data/data/medical_journal/meddinov3_preprocessed"
export nnUNet_results="/usr/bmicnas03/data-biwi-01/qimaqi_data/data/medical_journal/flexict_ct_results/" # flexict_results_fomo10k
