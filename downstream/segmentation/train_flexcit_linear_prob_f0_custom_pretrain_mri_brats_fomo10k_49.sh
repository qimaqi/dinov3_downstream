#!/bin/bash
#SBATCH --job-name=train_flexcit_linear_prob_f0_custom_pretrain_mri_brats_fomo10k1
#SBATCH --output=sbatch_log/train_flexcit_linear_prob_f0_custom_pretrain_mri_brats_fomo10k1_%j.out
#SBATCH --nodes=1
