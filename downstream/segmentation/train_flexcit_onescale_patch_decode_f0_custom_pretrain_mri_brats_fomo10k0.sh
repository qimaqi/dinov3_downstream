#!/bin/bash
#SBATCH --job-name=train_flexcit_onescale_patch_decode_f0_custom_pretrain_mri_brats_fomo10k0
#SBATCH --output=sbatch_log/train_flexcit_onescale_patch_decode_f0_custom_pretrain_mri_brats_fomo10k0_%j.out
#SBATCH --nodes=1
