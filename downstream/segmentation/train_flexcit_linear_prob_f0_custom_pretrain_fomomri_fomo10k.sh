#!/bin/bash
#SBATCH --job-name=train_flexcit_linear_prob_f0_custom_pretrain_mri_fomo10k
#SBATCH --output=sbatch_log/train_flexcit_linear_prob_f0_custom_pretrain_mri_fomo10k_%j.out
#SBATCH --nodes=1
