...
# start cache feature
python downstream/3d_classify/fomo_finetune_cls_from_slices.py   --task "${TASK_NAME}"   --processed_root "${PROCESSED_ROOT}"   --checkpoint "${FLEXICT_2D_CHECKPOINT}"   --train_split split_80_10_10   --test_split TEST_80_10_10   --fold 0   --slice_pool patch_cls   --modality_pool mean   --batch_size 1   --slice_batch_size 32   --epochs 20   --cache   --cache_path "${FOMO_CACHE_ROOT}"   "${EXTRA_ARGS[@]}"

python downstream/3d_classify/fomo_finetune_cls_from_slices.py   --task "${TASK_NAME}"   --processed_root "${PROCESSED_ROOT}"   --checkpoint "${FLEXICT_2D_CHECKPOINT}"   --train_split split_80_10_10   --test_split TEST_80_10_10   --fold 1   --slice_pool patch_cls   --modality_pool mean   --batch_size 1   --slice_batch_size 32   --epochs 20   --cache   --cache_path "${FOMO_CACHE_ROOT}"   "${EXTRA_ARGS[@]}"

python downstream/3d_classify/fomo_finetune_cls_from_slices.py   --task "${TASK_NAME}"   --processed_root "${PROCESSED_ROOT}"   --checkpoint "${FLEXICT_2D_CHECKPOINT}"   --train_split split_80_10_10   --test_split TEST_80_10_10   --fold 2   --slice_pool patch_cls   --modality_pool mean   --batch_size 1   --slice_batch_size 32   --epochs 20   --cache   --cache_path "${FOMO_CACHE_ROOT}"   "${EXTRA_ARGS[@]}"

python downstream/3d_classify/fomo_finetune_cls_from_slices.py   --task "${TASK_NAME}"   --processed_root "${PROCESSED_ROOT}"   --checkpoint "${FLEXICT_2D_CHECKPOINT}"   --train_split split_80_10_10   --test_split TEST_80_10_10   --fold 3   --slice_pool patch_cls   --modality_pool mean   --batch_size 1   --slice_batch_size 32   --epochs 20   --cache   --cache_path "${FOMO_CACHE_ROOT}"   "${EXTRA_ARGS[@]}"

python downstream/3d_classify/fomo_finetune_cls_from_slices.py   --task "${TASK_NAME}"   --processed_root "${PROCESSED_ROOT}"   --checkpoint "${FLEXICT_2D_CHECKPOINT}"   --train_split split_80_10_10   --test_split TEST_80_10_10   --fold 4   --slice_pool patch_cls   --modality_pool mean   --batch_size 1   --slice_batch_size 32   --epochs 20   --cache   --cache_path "${FOMO_CACHE_ROOT}"   "${EXTRA_ARGS[@]}"
