...
# start cache feature
python downstream/3d_classify/dinov3_finetune_cls_from_slices.py   --task "${TASK_NAME}"   --processed_root "${PROCESSED_ROOT}"   --output_dir "${OUTPUT_ROOT}"   --dinov3_checkpoint "${DINOV3_2D_CHECKPOINT}"   --train_split split_80_10_10   --test_split TEST_80_10_10   --fold 0   --slice_pool patch_cls   --modality_pool each   --batch_size 1   --slice_batch_size 32   --epochs 50   --cache   --cache_path "${FOMO_CACHE_ROOT}"   "${EXTRA_ARGS[@]}"

python downstream/3d_classify/dinov3_finetune_cls_from_slices.py   --task "${TASK_NAME}"   --processed_root "${PROCESSED_ROOT}"   --output_dir "${OUTPUT_ROOT}"   --dinov3_checkpoint "${DINOV3_2D_CHECKPOINT}"   --train_split split_80_10_10   --test_split TEST_80_10_10   --fold 1   --slice_pool patch_cls   --modality_pool each   --batch_size 1   --slice_batch_size 32   --epochs 50   --cache   --cache_path "${FOMO_CACHE_ROOT}"   "${EXTRA_ARGS[@]}"

python downstream/3d_classify/dinov3_finetune_cls_from_slices.py   --task "${TASK_NAME}"   --processed_root "${PROCESSED_ROOT}"   --output_dir "${OUTPUT_ROOT}"   --dinov3_checkpoint "${DINOV3_2D_CHECKPOINT}"   --train_split split_80_10_10   --test_split TEST_80_10_10   --fold 2   --slice_pool patch_cls   --modality_pool each   --batch_size 1   --slice_batch_size 32   --epochs 50   --cache   --cache_path "${FOMO_CACHE_ROOT}"   "${EXTRA_ARGS[@]}"

python downstream/3d_classify/dinov3_finetune_cls_from_slices.py   --task "${TASK_NAME}"   --processed_root "${PROCESSED_ROOT}"   --output_dir "${OUTPUT_ROOT}"   --dinov3_checkpoint "${DINOV3_2D_CHECKPOINT}"   --train_split split_80_10_10   --test_split TEST_80_10_10   --fold 3   --slice_pool patch_cls   --modality_pool each   --batch_size 1   --slice_batch_size 32   --epochs 50   --cache   --cache_path "${FOMO_CACHE_ROOT}"   "${EXTRA_ARGS[@]}"


python downstream/3d_classify/dinov3_finetune_cls_from_slices.py   --task "${TASK_NAME}"   --processed_root "${PROCESSED_ROOT}"   --output_dir "${OUTPUT_ROOT}"   --dinov3_checkpoint "${DINOV3_2D_CHECKPOINT}"   --train_split split_80_10_10   --test_split TEST_80_10_10   --fold 4   --slice_pool patch_cls   --modality_pool each   --batch_size 1   --slice_batch_size 32   --epochs 50   --cache   --cache_path "${FOMO_CACHE_ROOT}"   "${EXTRA_ARGS[@]}"
