...
RAW_ROOT="/usr/bmicnas02/data-biwi-01/bmicdatasets-originals/Originals/Challenge_Datasets/FOMO_Tasks"
...
OUTPUT_ROOT="${OUTPUT_ROOT:-${REPO_ROOT}/results/3d_classify/dinov3_cls003_patch_cls_each_robust_zscore_split_v0_repeat20_val8}"
