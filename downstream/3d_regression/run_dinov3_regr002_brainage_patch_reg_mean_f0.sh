#!/usr/bin/env bash
#SBATCH --job-name=run_dinov3_regr002_brainage_patch_reg_mean_f0
#SBATCH --output=sbatch_log/run_dinov3_regr002_brainage_patch_reg_mean_f0_%j.out
#SBATCH --nodes=1
...
OUTPUT_ROOT="${OUTPUT_ROOT:-${REPO_ROOT}/results/3d_regression/dinov3_slice_reg_5fold_brainage_patch_cls_meanf_0}"
